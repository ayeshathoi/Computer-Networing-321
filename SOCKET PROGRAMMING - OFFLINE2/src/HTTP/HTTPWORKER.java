...
public class HTTPWORKER implements Runnable {
    ...
    public HTTPWORKER(Socket socket) throws IOException {
        this.socket        = socket;
        this.File404       = htmlParsing("1805062_404.html");
        this.imageFile     = htmlParsing("1805062_Text_Image_Viewer.html");
        this.textFile      = imageFile;
        this.directoryFile = htmlParsing("1805062_forderViewer.html");
    }

    private String htmlParsing(String fileName) throws IOException
    {
        ...
        try {
            ...
            if (input.length() > 0) {
                        ...
                        if (ok) {
                            ...
                            if(!dir){
                                ...
                                if (requestedFile.getName().endsWith(".txt")) {
                                    ...
                                    type = textOpen.replace("<img src=\"{src}\">", htmlParsing(path));
                                }
                ...
                if(input.startsWith("UPLOAD")) {
                    ...
                    String FILENAME = input.substring("UPLOAD".length());
